...
publish-check:
	...
	curl -L https://djiangwei.github.io/macro-dashboard/output/us_2026Q2_v1.html | rg -n "US Dashboard|Official Data Gaps|chart-real_gdp_growth|chart-real_gdp_per_capita_growth"
