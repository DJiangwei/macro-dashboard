...
validate:
	...
	$(UV) run python -c "from pathlib import Path; text=Path('output/uk_2026Q2_v1.html').read_text(); assert all(token in text for token in ['Series: IHYQ', 'Series: YBHA', 'Series: ABJR', 'Series: NPQT', 'Series: IKBK', 'Series: IKBL', 'Series: MGRZ'])"
